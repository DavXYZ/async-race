...
import type { WinnerWithCar, CreateWinnerRequest, UpdateWinnerRequest, PaginationParams, SortParams } from "../../types"
...
export const fetchWinners = createAsyncThunk("winners/fetchWinners", async (params?: PaginationParams & SortParams) => {
...
export const createWinner = createAsyncThunk("winners/createWinner", async (winnerData: CreateWinnerRequest) => {
...
const winnersSlice = createSlice({
    ...
    reducers: {
        ...
        setSorting: (state, action: PayloadAction<{ sortBy: "id" | "wins" | "time"; sortOrder: "ASC" | "DESC" }>) => {
